if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BKmgy5w5ko0hFAAPTqvuRnFnku20gl3jkKSNq7fvJpWbbFy_rdXQy7NOuqsNT84uw156oQNE9zi6cQGx5oxfBJ8",
    clientId: "EZDIV5FVDWGV9IDMN3IX92LU",
    ...
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: '1VTBQFJI53BSZ3RAHS3V8S3U'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'JBLN4EPK69AHEN5EBHMZJVM5'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: '8874QYNLXYFFTI3ZX97GWPSN'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'Y6D9L1P6UZ2XN98QJV31QKIG',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'RS5JDDR4UBN5HSBGM32F8PRL',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: '6L1D7DI954WDZ1JU6AF9VMIK',
    },
    stockWidget: {
      ...
      textColor: "#ffffff",
      subscriptionText: "Повідомити мене, коли товар з'явиться",
      subscribedText: "Ми повідомимо вас, коли товар з'явиться",
      modalHtml: `<html>
<head>
...
<div class="modal" v-cloak id="el">
  <div class="modal-container">
    ...
    <h3 class="modal-title">Повідомити мене, коли товар з'явиться</h3>
    <p class="notification-message">Ми повідомимо вас, коли товар з'явиться</p>
    ...
    <template v-if="selectedChannel==='email'">
      ...
      <small style="color: red" v-if="!isEmailValid">Укажіть дійсну електронну адресу</small>
    </template>
    ...
    <div v-if="dataEntered" class="gw-success-message alert alert-success complete"> Ваше сповіщення зареєстровано
      <a href="#"
         class="action-close"
         @click.p.prevent="closeModal">Закрити</a>
    </div>
    ...
    <div class="marketing-container" v-if="shopifyMailingListEnabled">
      ...
      <label class="marketing-container-label" for="accepts_marketing">Підписатися на новини?</label>
    </div>
    <p class="privacy-text">Ми поважаємо вашу конфіденційність і нікому не надаємо вашу електронну пошту</p>
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        heading: "heading",
        subheading: "Ми повідомимо вас, коли товар з'явиться",
        notifyButtonTitle: "Відправити",
        privacyText: "Ми поважаємо вашу конфіденційність і нікому не надаємо вашу електронну пошту",
        emailWorkflowUniqueId: "JBLN4EPK69AHEN5EBHMZJVM5",
        smsWorkflowUniqueId: "8874QYNLXYFFTI3ZX97GWPSN",
        successText: "Ваше сповіщення зареєстровано",
        successCloseText: "Закрити",
        optInMarketingText: "Підписатися на новини?",
        email: "",
        phoneNumber: '',
...
`,
    ...
    priceDropWidget: {
      ...
      backgroundColor: "#000000",
      textColor: "#ffffff",
      subscriptionText: "Повідомити мене, коли ціна зменшиться",
